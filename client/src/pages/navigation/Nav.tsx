...
function VerticalNavbar() {
    ...
    return(
        <nav className="flex flex-col w-1/5 space-y-8 h-full content-start p-5 text-xl shadow-lg">
            ...
            <div className="space-y-6">
                {[
                    // label, icon, link
                    // dashboard
                    ["Dashboard", <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
            ...
            <div className="space-y-5 py-10">
                <button className="flex flex-row space-x-2" onClick={()=> settingsroute()}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
                ...
                <button className="flex flex-row space-x-2" onClick={()=>navigate("/")}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
...
export default function Nav() {
    return(
        <div className="home-screen flex-row">
            <VerticalNavbar />
            <div className="flex grow bg-gray-100 flex-col w-4/5 items-center py-8">
                <SearchBar />
                <Outlet />
            </div>
        </div>
